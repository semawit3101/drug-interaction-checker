...
* Graphs to represent drug interactions
* Breadth-First Search (BFS) to detect interaction paths
* Hash Sets for fast drug validation and lookup

## Features

* Direct drug interaction detection
* Indirect drug interaction detection
* Drug information lookup
* Fast search and validation
* User-friendly web interface

## Purpose

This project demonstrates how computer science can be applied in healthcare to improve medication safety and support better decision-making.
...
* CSS
* JavaScript
* Data Structures and Algorithms (Graphs, BFS, Hash Sets)
